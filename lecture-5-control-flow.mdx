...
```
___________________________________
Reach end of loop it goes back to the condition.
Until the " let number = 14 " because 14 is not less or equal to ' 12 ' 
___________________________________
---
...
___________________________________
8 % 3 // 2
8 slices for 3 personnes can't be divided equaly
___________________________________
---
...
Write a program that outputs all of the numbers from 0 to 25
...
Looking number with remender of 1
```
