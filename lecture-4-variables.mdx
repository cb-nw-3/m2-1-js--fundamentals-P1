...
let grandson = 'Morty';
```
If you make a let inside a statement, you can't call it outside. It's stuck inside the function. It has block scope.
if you use var, var can be used outside of it. 
---
## Defining variables
