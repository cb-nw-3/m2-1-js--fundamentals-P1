...
3. 1 < 2 && 2 > 1
	TRUE
4. 31 < 13 || (TRUE) 1 < 2 && 3 > 1 (TRUE)
	READ ODER LEFT TO RIGHT : TRUE
5. 400 <= 400 (TRUE) && 399 < 400 (TRUE) && (30 > 31 || 400 > 31) (TRUE)
	TRUE
6. true && false && false || false && true
	FALSE AND FALSE
7. true && false || true || false
...
___________________________________
Types
// Number: -99, NaN, 5, 23, 0, 7, -99
// String: 'hello', cat, '42'
// Arrays: ['mouse', 'cat', 'dog'], ['coconut', 24, 'banana']
// Objects: {name: 'bob', age: 23}, {product: 'cake', price: '50$'}
...
___________________________________
ISBN isAvailable and author
Type of price : string
___________________________________
